...
//walidacja parametrów z przygotowaniem zmiennych dla widoku
    ...
    public function action_calcCompute(){            
            ...
            if ($this->form->amount > 1000000 && !inRole('manager')) {
                ...
                $this->result->result = round((($this->form->amount * $this->form->interest_rate)/ 100 + $this->form->amount) / ($this->form->period * 12), 2);
		...
		//2.1 Nowy rekord
		if ($this->form->id == '') {
			getDB()->insert("creditcalc", [
				"amount" => $this->form->amount,
				"period" => $this->form->period,
				"interest_rate" => $this->form->interest_rate,
                                "monthly_installment" => $this->result->result,
