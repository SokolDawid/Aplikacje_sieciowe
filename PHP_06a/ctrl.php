...
switch ($action) {
	default :
                control(null, 'CalcCtrl', 'generateView', ['user','admin','manager']);
        case 'calc' :
                control(null, 'CalcCtrl', 'generateView', ['user','admin','manager']);
	case 'calcCompute' :
                control(null, 'CalcCtrl', 'process', ['user','admin','manager']);
	case 'inna' :
                control(null, 'InnaCtrl', 'generateView', ['user','admin','manager']);
        case 'login' :
                control(null, 'LoginCtrl', 'doLogin');
	case 'logout':
                control(null, 'LoginCtrl', 'doLogout', ['user','admin','manager']);
}
